(function (cjs, an) {
  ...
  (lib.Symbol3 = function (mode, startPosition, loop, reversed) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "Ah8B+Qg0g0AAhKQAAhIA0g0QA0g1BIAAQBKAAA0A1QAzA0AABIQAABKgzA0Qg0A0hKAAQhIAAg0g0g"
      );
    ...
    this.shape_1.graphics
      ...
      .s()
      .p(
        "AAADxQgdAAgUgUQgVgVAAgdIAAlVQAAgdAVgVQAUgUAdAAIAAAAQAeAAAUAUQAVAVAAAdIAAFVQAAAdgVAVQgUAUgeAAg"
      );
    ...
    lib.Symbol3,
    new cjs.Rectangle(0, 0.1, 59.9, 83.2),
    null
  );
  ...
  (lib.screenDisplay = function (mode, startPosition, loop, reversed) {
    ...
    this.shape.graphics
      ...
      .s()
      .p("A9qaXQkyAAAAktMAAAgrSQAAkuEyAAMA7WAAAQExAAAAEuMAAAArSQAAEtkxAAg");
    ...
    this.shape_1.graphics
      .f("#1C1B43")
      .s()
      .p("AzcRgQjIAAAAjIIAA8vQAAjIDIAAMAm5AAAQDIAAAADIIAAcvQAADIjIAAg");
    this.shape_1.setTransform(235.4427, 185.8309, 1.6292, 1.6594);

    this.shape_2 = new cjs.Shape();
    this.shape_2.graphics
      .lf(
        ["#36E7D5", "#FFFFFF", "#36E7D5", "#BBFFFF"],
        [0.071, 0.38, 0.733, 0.961],
        -0.1,
        -170.7,
        -0.1,
        170.7
    ...
    this.shape_3.graphics
      .lf(
        ["#36E7D5", "#FFFFFF", "#36E7D5", "#C0FFFF"],
        [0.067, 0.376, 0.729, 0.965],
        -0.1,
        -170.7,
        -0.1,
        170.7
    ...
    this.shape_4.graphics
      ...
      .s()
      .p(
        "A/rdCQlGABAAlNMAAAgvsQAAlLFGgBMA/YAAAQFFABAAFLMAAAAvsQAAFNlFgBgEgi1gVsMAAAArSQAAEtEyABMA7WAAAQExgBAAktMAAAgrSQAAkukxABMg7WAAAQkygBAAEug"
      );
    ...
    this.shape_5.graphics
      .lf(
        ["#36E7D5", "#FFFFFF", "#36E7D5", "#C4FFFF"],
        [0.063, 0.376, 0.725, 0.965],
        -0.1,
        -170.7,
        -0.1,
        170.7
    ...
    this.shape_6.graphics
      .lf(
        ["#36E7D5", "#FFFFFF", "#36E7D5", "#C9FFFF"],
        [0.055, 0.373, 0.725, 0.969],
        -0.1,
        -170.7,
        -0.1,
        170.7
    ...
    this.shape_7.graphics
      .lf(
        ["#36E7D5", "#FFFFFF", "#36E7D5", "#CDFFFF"],
        [0.051, 0.373, 0.722, 0.973],
        -0.1,
        -170.7,
        -0.1,
        170.7
    ...
    this.shape_8.graphics
      .lf(
        ["#36E7D5", "#FFFFFF", "#36E7D5", "#D2FFFF"],
        [0.047, 0.369, 0.718, 0.973],
        -0.1,
        -170.7,
        -0.1,
        170.7
    ...
    this.shape_9.graphics
      .lf(
        ["#36E7D5", "#FFFFFF", "#36E7D5", "#D6FFFF"],
        [0.043, 0.365, 0.714, 0.976],
        -0.1,
        -170.7,
        -0.1,
        170.7
    ...
    this.shape_10.graphics
      .lf(
        ["#36E7D5", "#FFFFFF", "#36E7D5", "#DBFFFF"],
        [0.039, 0.365, 0.71, 0.98],
        -0.1,
        -170.7,
        -0.1,
        170.7
    ...
    this.shape_11.graphics
      .lf(
        ["#36E7D5", "#FFFFFF", "#36E7D5", "#DFFFFF"],
        [0.031, 0.361, 0.71, 0.98],
        -0.1,
        -170.7,
        -0.1,
        170.7
    ...
    this.shape_12.graphics
      .lf(
        ["#36E7D5", "#FFFFFF", "#36E7D5", "#E4FFFF"],
        [0.027, 0.361, 0.706, 0.984],
        -0.1,
        -170.7,
        -0.1,
        170.7
    ...
    this.shape_13.graphics
      .lf(
        ["#36E7D5", "#FFFFFF", "#36E7D5", "#E8FFFF"],
        [0.024, 0.357, 0.702, 0.988],
        -0.1,
        -170.7,
        -0.1,
        170.7
    ...
    this.shape_14.graphics
      .lf(
        ["#36E7D5", "#FFFFFF", "#36E7D5", "#EDFFFF"],
        [0.02, 0.353, 0.698, 0.988],
        -0.1,
        -170.7,
        -0.1,
        170.7
    ...
    this.shape_15.graphics
      .lf(
        ["#36E7D5", "#FFFFFF", "#36E7D5", "#F1FFFF"],
        [0.016, 0.353, 0.694, 0.992],
        -0.1,
        -170.7,
        -0.1,
        170.7
    ...
    this.shape_16.graphics
      .lf(
        ["#36E7D5", "#FFFFFF", "#36E7D5", "#F6FFFF"],
        [0.008, 0.349, 0.694, 0.996],
        -0.1,
        -170.7,
        -0.1,
        170.7
    ...
    this.shape_17.graphics
      .lf(
        ["#36E7D5", "#FFFFFF", "#36E7D5", "#FAFFFF"],
        [0.004, 0.349, 0.69, 0.996],
        -0.1,
        -170.7,
        -0.1,
        170.7
    ...
    this.timeline.addTween(
      cjs.Tween.get({})
        ...
        .to({ state: [{ t: this.shape_1 }, { t: this.shape }] }, 1)
        .to({ state: [{ t: this.shape_1 }, { t: this.shape }] }, 1)
        .to({ state: [{ t: this.shape_1 }, { t: this.shape_2 }] }, 1)
        .to({ state: [{ t: this.shape_4 }, { t: this.shape_3 }] }, 1)
        .to({ state: [{ t: this.shape_4 }, { t: this.shape_5 }] }, 1)
        .to({ state: [{ t: this.shape_4 }, { t: this.shape_6 }] }, 1)
        .to({ state: [{ t: this.shape_4 }, { t: this.shape_7 }] }, 1)
        .to({ state: [{ t: this.shape_4 }, { t: this.shape_8 }] }, 1)
        .to({ state: [{ t: this.shape_4 }, { t: this.shape_9 }] }, 1)
        .to({ state: [{ t: this.shape_4 }, { t: this.shape_10 }] }, 1)
        .to({ state: [{ t: this.shape_4 }, { t: this.shape_11 }] }, 1)
        .to({ state: [{ t: this.shape_4 }, { t: this.shape_12 }] }, 1)
        .to({ state: [{ t: this.shape_4 }, { t: this.shape_13 }] }, 1)
        .to({ state: [{ t: this.shape_4 }, { t: this.shape_14 }] }, 1)
        .to({ state: [{ t: this.shape_4 }, { t: this.shape_15 }] }, 1)
        .to({ state: [{ t: this.shape_4 }, { t: this.shape_16 }] }, 1)
        .to({ state: [{ t: this.shape_4 }, { t: this.shape_17 }] }, 1)
        .to({ state: [{ t: this.shape_1 }, { t: this.shape }] }, 1)
        .wait(1)
    );
  ...
  (lib.machineScreen = function (mode, startPosition, loop, reversed) {
    ...
    this.shape.graphics
      ...
      .s()
      .p("AyNQLQi8AAAAi4IAA6kQAAi6C8AAMAkbAAAQC8AAgBC6IAAakQABC4i8AAg");
    ...
    this.shape_3.graphics
      .lf(
        ["#47E9D9", "#EBFDFB", "#4AE9D9", "#B2F7F1", "#B6F8F3"],
        [0.184, 0.475, 0.773, 0.988, 1],
        0,
        -104.8,
        0,
        104.8
    ...
    this.shape_4.graphics
      ...
      .s()
      .p(
        "AzcR1QjIAAAAjMIAA9RQAAjMDIAAMAm5AAAQDIAAAADMIAAdRQAADMjIAAgA1YtTIAAakQAAC5C8AAMAkbAAAQC7AAAAi5IAA6kQAAi5i7AAMgkbAAAQi8AAAAC5g"
      );
    ...
    this.shape_5.graphics
      .lf(
        ["#58ECDD", "#D7FAF7", "#5EECDD", "#A4F5EE", "#ACF8F1"],
        [0.18, 0.463, 0.757, 0.976, 1],
        0,
        -104.8,
        0,
        104.8
    ...
    this.shape_6.graphics
      .lf(
        ["#69EEE1", "#C3F8F2", "#72EEE2", "#97F4EB", "#A2F7F0"],
        [0.173, 0.447, 0.741, 0.965, 1],
        0,
        -104.8,
        0,
        104.8
    ...
    this.shape_7.graphics
      .lf(
        ["#7AF1E5", "#AFF5EE", "#86F1E6", "#89F2E8", "#98F7EE"],
        [0.169, 0.435, 0.725, 0.953, 1],
        0,
        -104.8,
        0,
        104.8
    ...
    this.shape_8.graphics
      .lf(
        ["#8BF3E9", "#9BF3EA", "#9BF3EA", "#7BF0E5", "#8FF6ED"],
        [0.161, 0.424, 0.71, 0.941, 1],
        0,
        -104.8,
        0,
        104.8
    ...
    this.shape_9.graphics
      .lf(
        ["#9CF5EC", "#86F1E6", "#AFF5EE", "#6DEEE1", "#85F5EC"],
        [0.153, 0.412, 0.694, 0.929, 1],
        0,
        -104.8,
        0,
        104.8
    ...
    this.shape_10.graphics
      .lf(
        ["#ADF8F0", "#72EEE2", "#C3F8F2", "#5FECDE", "#7BF5EA"],
        [0.149, 0.4, 0.678, 0.918, 1],
        0,
        -104.8,
        0,
        104.8
    ...
    this.shape_11.graphics
      .lf(
        ["#BEFAF4", "#5EECDD", "#D7FAF7", "#52EBDB", "#71F4E9"],
        [0.141, 0.384, 0.663, 0.906, 1],
        0,
        -104.8,
        0,
        104.8
    ...
    this.shape_12.graphics
      .lf(
        ["#CFFDF8", "#4AE9D9", "#EBFDFB", "#44E9D8", "#67F4E7"],
        [0.137, 0.373, 0.647, 0.894, 1],
        0,
        -104.8,
        0,
        104.8
    ...
    this.shape_13.graphics
      .lf(
        ["#E0FFFC", "#36E7D5", "#FFFFFF", "#36E7D5", "#5DF3E6"],
        [0.129, 0.361, 0.631, 0.882, 1],
        0,
        -104.8,
        0,
        104.8
    ...
    this.shape_14.graphics
      .lf(
        ["#CFFDF8", "#47E9D9", "#EBFDFB", "#4AE9D9", "#59F2E4"],
        [0.122, 0.357, 0.624, 0.878, 1],
        0,
        -104.8,
        0,
        104.8
    ...
    this.shape_15.graphics
      .lf(
        ["#BFFAF4", "#58ECDD", "#D7FAF7", "#5EECDD", "#55F1E3"],
        [0.118, 0.353, 0.62, 0.875, 1],
        0,
        -104.8,
        0,
        104.8
    ...
    this.shape_16.graphics
      .lf(
        ["#AEF8F1", "#69EEE1", "#C3F8F2", "#72EEE2", "#51EFE1"],
        [0.11, 0.345, 0.612, 0.875, 0.996],
        0,
        -104.8,
        0,
        104.8
    ...
    this.shape_17.graphics
      .lf(
        ["#9DF6ED", "#7AF1E5", "#AFF5EE", "#86F1E6", "#4DEEDF"],
        [0.102, 0.341, 0.608, 0.871, 0.996],
        0,
        -104.8,
        0,
        104.8
    ...
    this.shape_18.graphics
      .lf(
        ["#8DF4E9", "#8BF3E9", "#9BF3EA", "#9BF3EA", "#4AEDDE"],
        [0.098, 0.337, 0.6, 0.867, 0.996],
        0,
        -104.8,
        0,
        104.8
    ...
    this.shape_19.graphics
      .lf(
        ["#7CF1E5", "#9CF5EC", "#86F1E6", "#AFF5EE", "#46ECDC"],
        [0.09, 0.333, 0.592, 0.863, 0.996],
        0,
        -104.8,
        0,
        104.8
    ...
    this.shape_20.graphics
      .lf(
        ["#6BEFE1", "#ADF8F0", "#72EEE2", "#C3F8F2", "#42EBDA"],
        [0.082, 0.329, 0.588, 0.859, 0.996],
        0,
        -104.8,
        0,
        104.8
    ...
    this.shape_21.graphics
      .lf(
        ["#5AEDDE", "#BEFAF4", "#5EECDD", "#D7FAF7", "#3EE9D8"],
        [0.075, 0.322, 0.58, 0.859, 0.992],
        0,
        -104.8,
        0,
        104.8
    ...
    this.shape_22.graphics
      .lf(
        ["#4AEADA", "#CFFDF8", "#4AE9D9", "#EBFDFB", "#3AE8D7"],
        [0.071, 0.318, 0.576, 0.855, 0.992],
        0,
        -104.8,
        0,
        104.8
    ...
    this.shape_23.graphics
      .lf(
        ["#39E8D6", "#E0FFFC", "#36E7D5", "#FFFFFF", "#36E7D5"],
        [0.063, 0.314, 0.569, 0.851, 0.992],
        0,
        -104.8,
        0,
        104.8
    ...
    this.shape_24.graphics
      .lf(
        ["#39E8D6", "#E3FFFC", "#36E7D5", "#FFFFFF", "#4AE9D9"],
        [0.055, 0.318, 0.58, 0.867, 0.992],
        0,
        -104.8,
        0,
        104.8
    ...
    this.shape_25.graphics
      .lf(
        ["#38E8D6", "#E6FFFD", "#36E7D5", "#FFFFFF", "#5EECDD"],
        [0.051, 0.322, 0.592, 0.882, 0.992],
        0,
        -104.8,
        0,
        104.8
    ...
    this.shape_26.graphics
      .lf(
        ["#38E8D6", "#E9FFFD", "#36E7D5", "#FFFFFF", "#72EEE2"],
        [0.043, 0.322, 0.604, 0.894, 0.996],
        0,
        -104.8,
        0,
        104.8
    ...
    this.shape_27.graphics
      .lf(
        ["#38E8D6", "#ECFFFD", "#36E7D5", "#FFFFFF", "#86F1E6"],
        [0.039, 0.325, 0.616, 0.91, 0.996],
        0,
        -104.8,
        0,
        104.8
    ...
    this.shape_28.graphics
      .lf(
        ["#37E7D5", "#F0FFFE", "#36E7D5", "#FFFFFF", "#9BF3EA"],
        [0.031, 0.329, 0.627, 0.925, 0.996],
        0,
        -104.8,
        0,
        104.8
    ...
    this.shape_29.graphics
      .lf(
        ["#37E7D5", "#F3FFFE", "#36E7D5", "#FFFFFF", "#AFF6EE"],
        [0.027, 0.333, 0.639, 0.941, 0.996],
        0,
        -104.8,
        0,
        104.8
    ...
    this.shape_30.graphics
      .lf(
        ["#37E7D5", "#F6FFFE", "#36E7D5", "#FFFFFF", "#C3F8F3"],
        [0.02, 0.333, 0.651, 0.953, 1],
        0,
        -104.8,
        0,
        104.8
    ...
    this.shape_31.graphics
      .lf(
        ["#36E7D5", "#F9FFFF", "#36E7D5", "#FFFFFF", "#D7FBF7"],
        [0.016, 0.337, 0.663, 0.969, 1],
        0,
        -104.8,
        0,
        104.8
    ...
    this.shape_32.graphics
      .lf(
        ["#36E7D5", "#FCFFFF", "#36E7D5", "#FFFFFF", "#EBFDFB"],
        [0.008, 0.341, 0.675, 0.984, 1],
        0,
        -104.8,
        0,
        104.8
    ...
    this.timeline.addTween(
      cjs.Tween.get({})
        ...
        .to({ state: [{ t: this.shape_4 }, { t: this.shape_11 }] }, 1)
        .to({ state: [{ t: this.shape_4 }, { t: this.shape_12 }] }, 1)
        .to({ state: [{ t: this.shape_1 }, { t: this.shape_13 }] }, 1)
        .to({ state: [{ t: this.shape_4 }, { t: this.shape_14 }] }, 1)
        .to({ state: [{ t: this.shape_4 }, { t: this.shape_15 }] }, 1)
        .to({ state: [{ t: this.shape_4 }, { t: this.shape_16 }] }, 1)
        .to({ state: [{ t: this.shape_4 }, { t: this.shape_17 }] }, 1)
        .to({ state: [{ t: this.shape_4 }, { t: this.shape_18 }] }, 1)
        .to({ state: [{ t: this.shape_4 }, { t: this.shape_19 }] }, 1)
        .to({ state: [{ t: this.shape_4 }, { t: this.shape_20 }] }, 1)
        .to({ state: [{ t: this.shape_4 }, { t: this.shape_21 }] }, 1)
        .to({ state: [{ t: this.shape_4 }, { t: this.shape_22 }] }, 1)
        .to({ state: [{ t: this.shape_1 }, { t: this.shape_23 }] }, 1)
        .to({ state: [{ t: this.shape_4 }, { t: this.shape_24 }] }, 1)
        .to({ state: [{ t: this.shape_4 }, { t: this.shape_25 }] }, 1)
        .to({ state: [{ t: this.shape_4 }, { t: this.shape_26 }] }, 1)
        .to({ state: [{ t: this.shape_4 }, { t: this.shape_27 }] }, 1)
        .to({ state: [{ t: this.shape_4 }, { t: this.shape_28 }] }, 1)
        .to({ state: [{ t: this.shape_4 }, { t: this.shape_29 }] }, 1)
        .to({ state: [{ t: this.shape_4 }, { t: this.shape_30 }] }, 1)
        .to({ state: [{ t: this.shape_4 }, { t: this.shape_31 }] }, 1)
        .to({ state: [{ t: this.shape_4 }, { t: this.shape_32 }] }, 1)
        .wait(1)
    );
  ...
  (lib.machineKeyboard = function (mode, startPosition, loop, reversed) {
    ...
    lib.machineKeyboard,
    new cjs.Rectangle(0, 0, 314.5, 42),
    null
  );
  ...
  (lib.machineBtn = function (mode, startPosition, loop, reversed) {
    ...
    this.shape = new cjs.Shape();
    this.shape.graphics
      .rf(["#D4B1EA", "#6426AB"], [0, 1], -3.3, -5.2, 0, -3.3, -5.2, 12.4)
      .s()
      .p(
        "AhUBUQgigigBgyQABgwAigkQAkgiAwgBQAxABAjAiQAkAkgBAwQABAygkAiQgjAkgxgBQgwABgkgkg"
      );
  ...
  (lib.endGame = function (mode, startPosition, loop, reversed) {
    ...
    this.shape.graphics
      ...
      .s("#FFFFFF")
      .ss(3, 1, 1)
      .p("EhlZg7ZMDKzAAAMAAAB2zMjKzAAAg");
    ...
    this.shape_1.graphics
      .f("rgba(0,0,0,0.718)")
      .s()
      .p("EhlZA7aMAAAh2zMDKzAAAMAAAB2zg");
    ...
    lib.endGame,
    new cjs.Rectangle(-1.5, -1.5, 1301, 763.4),
    null
  );
  ...
  (lib.dboardBtn = function (mode, startPosition, loop, reversed) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "A9DHjQjIAAiNiOQiNiNAAjIIAAAAQAAjHCNiOQCNiNDIAAMA6GAAAQDJAACMCNQCOCOAADHIAAAAQAADIiOCNQiMCOjJAAg"
      );
    ...
    this.shape_1.graphics
      ...
      .ss(3, 1, 1)
      .p(
        "A9CniMA6GAAAQDIAACNCNQCNCOAADHIAAAAQAADIiNCNQiNCOjIAAMg6GAAAQjIAAiOiOQiNiNAAjIIAAAAQAAjHCNiOQCOiNDIAAg"
      );
    ...
    this.timeline.addTween(
      cjs.Tween.get({})
        .to({ state: [{ t: this.shape }, { t: this.text }] })
        .to(
          {
            state: [{ t: this.shape_2 }, { t: this.shape_1 }, { t: this.text }],
          },
          1
        )
        .wait(1)
  ...
  (lib.continueBtn = function (mode, startPosition, loop, reversed) {
    ...
    this.shape.graphics
      ...
      .ss(3, 1, 1)
      .p(
        "A6FlbMA0LAAAQCQAABmBmQBmBmAACPIAAAAQAACQhmBmQhmBmiQAAMg0LAAAQiQAAhmhmQhmhmAAiQIAAAAQAAiPBmhmQBmhmCQAAg"
      );
    ...
    this.shape_1.graphics
      .lf(
        ["#7A4E9B", "#7A4E9B", "#7A4E9B", "#7A4E9B", "#2E2D6C"],
        [0, 0, 0, 0, 1],
        -201.7,
        0,
        201.8,
      ...
      .s()
      .p(
        "A6FFcQiQAAhmhmQhmhmAAiQIAAAAQAAiPBmhmQBmhmCQAAMA0LAAAQCQAABmBmQBmBmAACPIAAAAQAACQhmBmQhmBmiQAAg"
      );
    ...
    this.timeline.addTween(
      cjs.Tween.get({})
        .to({
          state: [{ t: this.shape_1 }, { t: this.shape }, { t: this.text }],
        })
        .wait(1)
    );
  ...
  (lib.confirmNameBtn = function (mode, startPosition, loop, reversed) {
    ...
    this.timeline.addTween(
      cjs.Tween.get({})
        .to({ state: [{ t: this.shape }, { t: this.text }] })
        .to(
          { state: [{ t: this.shape }, { t: this.shape_1 }, { t: this.text }] },
          1
        )
        .wait(1)
    );
  ...
  (lib.lever = function (mode, startPosition, loop, reversed) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.lever)
        .wait(1)
        .to({ regX: 27.5, regY: 39.1, rotation: -25.6084, x: 72.1, y: 35.9 }, 0)
        .wait(1)
        .to({ rotation: -51.2168, x: 64.85, y: 59.45 }, 0)
        .wait(1)
        .to({ rotation: -76.8252, x: 68.25, y: 83.4 }, 0)
        .wait(1)
        .to({ rotation: -102.4336, x: 81.7, y: 103.25 }, 0)
        .wait(1)
        .to({ rotation: -128.042, x: 102.15, y: 114.95 }, 0)
        .wait(1)
        .to({ rotation: -113.8151, x: 89.65, y: 109.6 }, 0)
        .wait(1)
        .to({ rotation: -99.5882, x: 78.8, y: 101.4 }, 0)
        .wait(1)
        .to({ rotation: -85.3613, x: 70.3, y: 90.75 }, 0)
        .wait(1)
        .to({ rotation: -71.1344, x: 64.85, y: 78.45 }, 0)
        .wait(1)
        .to({ rotation: -56.9076, x: 62.8, y: 65 }, 0)
        .wait(1)
        .to({ rotation: -42.6807, x: 64.3, y: 51.45 }, 0)
        .wait(1)
        .to({ rotation: -28.4538, x: 69.35, y: 38.5 }, 0)
        .wait(1)
        .to({ rotation: -14.2269, x: 77.55, y: 27 }, 0)
        .wait(1)
        .to({ rotation: 0, x: 88.65, y: 17.5 }, 0)
        .wait(1)
    );
      ...
      cjs.Tween.get({})
        .to({
          state: [
            { t: this.instance_1 },
            {
              t: this.machineScreen,
              p: { regX: 0, regY: 0, x: 23.15, y: 43.8 },
            },
            { t: this.machineLever },
            { t: this.instance },
            { t: this.machineBtn1 },
        ...
        .to(
          {
            state: [
              ...
              {
                t: this.machineScreen,
                p: { regX: 144.6, regY: 114, x: 157.9, y: 157.8 },
              },
              { t: this.machineLever },
              { t: this.instance_2 },
            ],
  ...
  (lib.helloworld = function (mode, startPosition, loop, reversed) {
      ...
      if (!root.nameInput_change_cbk) {
        function nameInput_change(evt) {
          ...
          if (pName == "") {
            ...
            root.screenText.text =
              "Your name is " + pName + "!\nIs this correct?";
            playerName = pName;
          }
        }
        $("#dom_overlay_container").on(
          "change",
          "#nameInput",
          nameInput_change.bind(this)
        );
    ...
    // helloworld
    this.promptAnswer = new cjs.Text(
    ...
    this.userInput = new lib.an_TextInput({
      id: "userInput",
      value: "",
      disabled: false,
      visible: true,
    ...
    // askforname
    this.nameInput = new lib.an_TextInput({
      id: "nameInput",
      value: "",
      disabled: false,
      visible: true,
    ...
    this.timeline.addTween(
      cjs.Tween.get({})
        .to({
          state: [
            { t: this.machine },
            { t: this.screenDisplay },
            { t: this.yesBtn },
            { t: this.noBtn },
            { t: this.userAnsDisplay },
            { t: this.screenText },
          ],
        })
        .wait(1)
  ...
  lib.properties = {
    ...
    manifest: [
      ...
      {
        src: "images/helloworld_atlas_1.png?1613103413999",
        id: "helloworld_atlas_1",
      },
      {
        src: "images/helloworld_atlas_2.png?1613103413999",
        id: "helloworld_atlas_2",
      },
      {
        src: "https://code.jquery.com/jquery-3.4.1.min.js?1613103414137",
        id: "lib/jquery-3.4.1.min.js",
      },
      {
        src: "components/sdk/anwidget.js?1613103414137",
        id: "sdk/anwidget.js",
      },
      {
        src: "components/ui/src/textinput.js?1613103414137",
        id: "an.TextInput",
      },
    ],
    preloads: [],
