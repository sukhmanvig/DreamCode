        ...
        <>
            ...
            <div className="profile-content">
                <section className="p-head">
                    <div id="user-pfp">
                        <img alt="profile" src="https://www.thispersondoesnotexist.com/image"/>
                    </div>
                    <div id="user-infosec">
                        ...
                        <p>XP</p>
                        <div className="bio">
                        {bio !== "" ? <div className="">{bio}</div> :<div className="error">{error}</div>}
                        
                        </div>
                    </div>
                    <div id="circle-stats" title="XP">
                        <svg>
                            <circle className="circle-xp" cx="125" cy="125" r="100"></circle>
                        </svg>
                ...
                <div className="profile-div-right">
                    <section className="pf-sec sec-badges">
                        <h4>BADGES</h4>
                            <div className="ubadge" title="Say Hello to Coding!">
                            </div>
                            <div className="ubadge" title="Badge Name">
                            </div>
                            <div className="ubadge" title="Badge Name">
                            </div>
                            <div className="ubadge" title="Badge Name">
