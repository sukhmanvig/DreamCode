          ...
          <Link to="/login" style={{textDecoration: 'none' }}><div id="btnStartLearn">Start Learning</div></Link>
			...
			<section className="rowSec">
				...
				<section className="gamePrevs">
					<div><img src="/images/gprevifs.png" alt="If Statement Game"/></div>
					<div><img src="/images/gprevlists.png" alt="Lists Game"/></div>
					<div><img src="/images/gprevqueues.png" alt="Queues Game"/></div>
				</section>
			</section>
			<section className="rowSec">
				<h2>Meet The Devs</h2>
				<div className="customCar">
					<div className="customCard">
						<div className="devImg"><img alt="Akeem Brisco"/></div>
					...
					<div className="customCard">
						<div className="devImg"><img alt="Arnaud Michel"/></div>
						<div className="cardInfo">
						<h3>Arnaud Michel</h3>
						<p>Computer Science Student, University of Toronto Mississauga.</p>
						</div>
					...
					<div className="customCard">
						<div className="devImg"><img alt="Jazelle Diaz"/></div>
						<div className="cardInfo">
						<h3>Jazelle Diaz</h3>
					...
					<div className="customCard">
						<div className="devImg"><img alt="Jayvin Chang"/></div>
						<div className="cardInfo">
						<h3>Jayvin Chang</h3>
					...
					<div className="customCard">						
						<div className="devImg"><img alt="Komal Kaler"/></div>
						<div className="cardInfo">
						<h3>Komal Kaler</h3>
						<p>Computer Science Student, University of Toronto Mississauga.</p>
						</div>
					...
					<div className="customCard">
						<div className="devImg"><img alt="Hao Mack Lee"/></div>
						<div className="cardInfo">
						<h3>Hao Mack Lee</h3>
						<p>Computer Science Student, University of Toronto Mississauga.</p>
						</div>
