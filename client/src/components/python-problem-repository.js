  ...
  return (
    <body className="ppr">
      <div className="container-fluid">
        ...
        <p id="italize">
          First attempt the problem on your own, then click on the problem to
        ...
        <div className="icon_accordion">
          <div className="icon"></div>
          <h5>
            Write a program that takes a list of numbers (for example, a = [5,
            10, 15, 20, 25]) and makes a new list of only the first and last
            elements of the given list. For practice, write this code inside a
            function.
          </h5>
        </div>
        <div className="panel">
        ...
        <div className="icon_accordion">
          ...
          <h5>
            ...
            contains all the elements of the first list minus all the
            duplicates.
          </h5>
        </div>
        <div className="panel">
